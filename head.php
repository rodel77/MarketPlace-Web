...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.20.1/moment.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.20.1/locale/<?php echo MOMENT_LANG; ?>.js"></script>
</head>
        ...
        <div class="row align-items-center justify-content-center" style="height:100vh;">
            <div class="col col-10 col-lg-9 col-xl-6">
                <div class="card bg-inventory text-light">
                    ...
                    <p class="color-6 minefont">Please update your WebMarket version in order to continue!</p>
                    </div>
                </div>
            </div>
        </div>
